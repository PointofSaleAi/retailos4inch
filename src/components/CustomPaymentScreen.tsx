...
export const CustomPaymentScreen = ({
  ...
  return <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-1 flex justify-center overflow-y-auto">
        ...
        {/* Numeric Keypad */}
        <div className="grid grid-cols-4 gap-[6px] p-[3px]">
          {/* Row 1 */}
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("9")}>
            9
          </Button>
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("8")}>
            8
          </Button>
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("7")}>
            7
          </Button>
          <Button variant="outline" className="h-[90px] row-span-2 bg-surface hover:bg-surface/80 border-border/50 flex items-center justify-center rounded-xl" onClick={handleBackspace}>
          ...
          {/* Row 3 */}
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("3")}>
            3
          </Button>
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("2")}>
            2
          </Button>
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("1")}>
            1
          </Button>
          <Button variant="outline" className="h-[90px] row-span-2 bg-surface hover:bg-surface/80 border-border/50 flex items-center justify-center rounded-xl" onClick={handleAddToCart}>
            <Plus className="w-6 h-6" />
          </Button>

          {/* Row 4 */}
          <Button variant="outline" className="h-[42px] col-span-2 text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("00")}>
            00
          </Button>
          <Button variant="outline" className="h-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("0")}>
            0
          </Button>
        </div>
        </div>
