  ...
  return <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-1 flex justify-center overflow-y-auto">
        ...
        <div className="grid grid-cols-4 gap-[2px]">
          {/* Row 1 */}
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("7")}>
            7
          </Button>
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("8")}>
            8
          </Button>
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("9")}>
            9
          </Button>
          <Button variant="outline" className="h-[82px] w-[42px] row-span-2 bg-surface hover:bg-surface/80 border-border/50 flex items-center justify-center rounded-xl" onClick={handleBackspace}>
            <Delete className="w-5 h-5 rotate-180" />
          </Button>

          {/* Row 2 */}
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("4")}>
            4
          </Button>
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("5")}>
            5
          </Button>
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("6")}>
            6
          </Button>

          {/* Row 3 */}
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("1")}>
            1
          </Button>
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("2")}>
            2
          </Button>
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("3")}>
            3
          </Button>
          <Button variant="outline" className="h-[82px] w-[42px] row-span-2 bg-surface hover:bg-surface/80 border-border/50 flex items-center justify-center rounded-xl">
          ...
          <Button variant="outline" className="h-[40px] w-[42px] text-base font-medium bg-surface hover:bg-surface/80 border-border/50 rounded-xl" onClick={() => handleNumberClick("0")}>
            0
          </Button>
        </div>
        </div>
