...
export const RefundScreen = ({ products, onBack, onNext }: RefundScreenProps) => {
  ...
  return (
    <div className="h-full flex items-center justify-center bg-background p-[6px]">
      <div className="w-[186px] h-[186px] flex flex-col bg-background">
        {/* Header */}
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto scrollbar-hide mb-2">
          {activeTab === "products" ? (
            ...
            <div className="space-y-2">
              ...
              <div className="bg-background rounded-lg border border-border h-[36px] flex items-center justify-center">
                <span className="text-[18px] font-bold" style={{ color: '#FF0000' }}>
                  ${refundAmount}
                </span>
              </div>
              ...
              <div className="grid grid-cols-3 gap-[3px]">
                {['7', '8', '9', '4', '5', '6', '1', '2', '3', '.', '0', 'C'].map((key) => (
                  <button
                    ...
                    className="h-[36px] rounded-lg border border-border bg-background flex items-center justify-center text-[18px] font-semibold transition-colors hover:bg-muted"
