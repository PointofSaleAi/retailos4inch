...
export const ProductDetailSheet = ({
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onClose}>
      <DrawerContent container={portalContainer} className="w-[198px] mx-auto rounded-t-[16px] bottom-0 max-h-[calc(100svh-10px)] overflow-y-auto pb-0 overscroll-contain">
