      ...
      <div className="border-t border-gray-200 space-y-1 px-0 py-0">
        ...
        {discountAmount > 0 && (
          <div className="flex justify-between items-center">
            ...
            <span className="text-[9px] font-medium text-[#CC0000]">-${discountAmount.toFixed(2)}</span>
          </div>
        )}
        {taxAmount > 0 && (
          <div className="flex justify-between items-center">
            <span className="text-[9px] font-medium text-[#212121]">Tax @ {appliedTax?.rateDisplay}</span>
