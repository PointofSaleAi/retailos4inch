...
export const TransactionDetailScreen = ({
  ...
  return <div className="w-[186px] h-full flex flex-col bg-background">
      {/* Header */}
      <div className="flex-shrink-0 flex items-center justify-between py-2.5 px-0">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide px-0">
        ...
        <div className="py-2 space-y-2">
          ...
          <div className="rounded-lg p-2 flex items-center justify-between" style={{
      ...
      {/* Refund Button */}
      <div className="flex-shrink-0 py-2.5 border-t border-border px-0">
